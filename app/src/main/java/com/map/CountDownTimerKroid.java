 ...
 */
public abstract class CountDownTimerKroid {
   ...
   */
    ...
    /**
     * @parammillisInFuture The number of millis in the future from the call
     ...
     */
    public CountDownTimerKroid(long millisOnTimer, long countDownInterval, boolean runAtStart) {
     ...
     */
    public synchronized final CountDownTimerKroid create() {
  ...
  public boolean hasBeenStarted() {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            synchronized (CountDownTimerKroid.this) {
